...
<div class="header bg-main">
  <div style="float:left" class="logo margin-big-left fadein-top">
    <h1><img src="images/admin.jpg" class="radius-circle rotate-hover" height="50" alt="" />管理中心</h1>
  </div>
  <div style="float:right; margin-right:5%" class="head-l"><a class="button button-little bg-blue" href="front/front_index.php" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;<!--<a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> 清除缓存</a> &nbsp;&nbsp;--><a class="button button-little bg-red" href="login.html"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav">
...
<ul class="bread">
  <li style="color:red; font-size:15px; font-weight:bold"><?php echo @$_SESSION['yh'] ?></span>管理员&nbsp;&nbsp;<span style="color:#3CF">欢迎您!!!</span></li>
</ul>
<div class="admin">
