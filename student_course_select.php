...
$sql1="select * from course where course_number=$course_select";
  ...
  ?> 
    ...
    <td width="100"><div align="center">选择</div></td>
  </tr>   
        <tr>
          <td>
            <?php
  ...
  <tr>
    ...
    <?php
				if(in_array($row['course_number'],$cno)){	
					echo "已选"	;
//					echo "  <a href='index.php?p=home&c=student&a=cancelSelect&cno={$v['cno']}' >退选</a> ";
				}else{
//					echo "未选"	;
//    echo" <input type='checkbox' name='kec[]' value='<?php echo {$row['course_number']} 
	?>
	<!--'/>";-->
