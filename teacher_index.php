...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <div style="float:left;"><h1><img src="images/teacher.jpg" class="radius-circle rotate-hover" height="50" alt="" />教师中心</h1></div>
  </div>
...
<ul class="bread">
  <li style="color:#F00; font-size:15px; font-weight:bold"><?php echo @$_SESSION['yh'] ?></span>老师&nbsp;&nbsp;<span style="color:#3CF">欢迎您!!!</span></li>
</ul>
 <div class="admin">
